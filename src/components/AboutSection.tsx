          ...
          <div className="text-center mb-12 animate-fade-up">
            ...
            <div className="bg-background/80 backdrop-blur-sm rounded-lg p-8 border border-border/20">
              ...
              <p className="text-base text-muted-foreground max-w-3xl mx-auto leading-relaxed mt-4">
                The tournament will be hosted at Underground Atlanta. Alongside the tournament there will be a watch party for two highly anticipated matches, Chelsea vs Manchester United @ 12:30 PM & Atlanta United vs San Diego FC @ 4:30 PM.
              </p>
            </div>

            {/* Instagram Post Embed */}
            <div className="mt-12 max-w-lg mx-auto">
              <div className="bg-background/80 backdrop-blur-sm rounded-lg p-6 border border-border/20">
                <blockquote 
                  className="instagram-media" 
                  data-instgrm-captioned 
                  data-instgrm-permalink="https://www.instagram.com/p/DOPcf5sjTwN/" 
                ...
                <p className="text-xs text-muted-foreground mt-4 text-center">
                  Note: Video will be replaced with looping HTML5 video for optimal performance
                </p>
              </div>
            </div>
          </div>
